...
function AddSubjectModal() {
	...
	const addSubjectSchema = Yup.object().shape({
		subject_name: Yup.string('Subject name should be in string').required('Subject name requied'),
	});
			...
			<CModal id={'add-subject-modal'} title={'Add Subject'}>
				<div className="flex flex-col gap-7">
					...
					<div className="relative">
						...
						<input type="text" name="subject_name" className="input-el w-full mt-2" ref={subjectNameRef} onChange={handleInputChange} />
