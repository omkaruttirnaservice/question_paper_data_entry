        ...
        <>
            <div className={`text-gray-600 bg-gray-100  sticky top-0 p-2 h-[100vh] overflow-auto`}>
                ...
                <div className="flex flex-col gap-1 py-1">
                    ...
                    <PreviewOptionContainer title={`Option A`} html={_formData.mqs_opt_one} />
                    <hr />
                    <PreviewOptionContainer title={`Option B`} html={_formData.mqs_opt_two} />
                    <hr />
                    <PreviewOptionContainer title={`Option C`} html={_formData.mqs_opt_three} />
                    <hr />
                    <PreviewOptionContainer title={`Option D`} html={_formData.mqs_opt_four} />
                    <hr />
                    ...
                    <p className="font-semibold text-sm py-2">
                        Correct Option&nbsp;&nbsp;
                        <span className="bg-gray-700 text-white p-1 font-bold">
                            {_formData.mqs_ans}
                        </span>
                    </p>
                    <hr />

                    <PreviewOptionContainer title={`Explanation`} html={_formData.mqs_solution} />
                    <hr />
                </div>
            </div>
        </>
