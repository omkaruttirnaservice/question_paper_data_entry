...
const questionModel = {
    ...
    getEditQuestionData: (id) => {
        const q = `
							SELECT 
								mqs.id id,
								mqs.mqs_question mqs_question,
								mqs.mqs_opt_one mqs_opt_one,
								mqs.mqs_opt_two mqs_opt_two,
								mqs.mqs_opt_three mqs_opt_three,
								mqs.mqs_opt_four mqs_opt_four,
								mqs.mqs_opt_five mqs_opt_five,
								mqs.mqs_ans mqs_ans,
								mqs.mqs_solution mqs_solution,
